...
public class DiscussjiankangwenzhangController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discussjiankangwenzhang,deSens);
    ...
    public R save(@RequestBody DiscussjiankangwenzhangEntity discussjiankangwenzhang, HttpServletRequest request){
        ...
        return R.ok().put("data",discussjiankangwenzhang.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscussjiankangwenzhangEntity discussjiankangwenzhang = discussjiankangwenzhangService.selectOne(new EntityWrapper<DiscussjiankangwenzhangEntity>().eq("", username));
        return R.ok().put("data", discussjiankangwenzhang);
    }
    ...
    public R update(@RequestBody DiscussjiankangwenzhangEntity discussjiankangwenzhang, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussjiankangwenzhang);
        //全部更新
        discussjiankangwenzhangService.updateById(discussjiankangwenzhang);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussjiankangwenzhangEntity discussjiankangwenzhang, HttpServletRequest request,String pre){
        EntityWrapper<DiscussjiankangwenzhangEntity> ew = new EntityWrapper<DiscussjiankangwenzhangEntity>();
