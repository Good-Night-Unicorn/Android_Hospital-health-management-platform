<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="评估标题" prop="pinggubiaoti" >
					<el-input v-model="ruleForm.pinggubiaoti" placeholder="评估标题" clearable  :readonly="ro.pinggubiaoti"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="评估标题" prop="pinggubiaoti" >
					<el-input v-model="ruleForm.pinggubiaoti" placeholder="评估标题" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="评估情况" prop="pingguqingkuang" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="评估情况"
					v-model="ruleForm.pingguqingkuang" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.pingguqingkuang" label="评估情况" prop="pingguqingkuang" >
				<span class="text">{{ruleForm.pingguqingkuang}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="运动建议" prop="yundongjianyi" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
			...
			<el-form-item v-else-if="ruleForm.yundongjianyi" label="运动建议" prop="yundongjianyi" >
				<span class="text">{{ruleForm.yundongjianyi}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="饮食建议" prop="yinshijianyi" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
			...
			<el-form-item v-else-if="ruleForm.yinshijianyi" label="饮食建议" prop="yinshijianyi" >
				<span class="text">{{ruleForm.yinshijianyi}}</span>
			</el-form-item>
