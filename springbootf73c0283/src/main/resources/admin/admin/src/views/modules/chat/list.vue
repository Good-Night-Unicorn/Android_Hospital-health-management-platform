				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #157ed2","cursor":"pointer","padding":"0 15px","margin":"0 5px 5px 0","color":"#1fc3cb","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20241006/ff34117d34d84517ad3d0a6a7bc7cb41.png) no-repeat center center / 100% 100%","width":"auto","fontSize":"14px","minWidth":"60px","height":"36px"}'
								size="small"
