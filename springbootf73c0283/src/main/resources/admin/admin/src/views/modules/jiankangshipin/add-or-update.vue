	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="健康分类" prop="jiankangfenlei" >
					<el-select :disabled="ro.jiankangfenlei" v-model="ruleForm.jiankangfenlei" placeholder="请选择健康分类" >
						<el-option
							v-for="(item,index) in jiankangfenleiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="健康分类" prop="jiankangfenlei" >
					<el-input v-model="ruleForm.jiankangfenlei"
						placeholder="健康分类" readonly></el-input>
				</el-form-item>
			</template>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springbootf73c0283/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
