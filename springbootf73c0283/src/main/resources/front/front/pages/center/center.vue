			...
			<view v-if="user&&user.id" :style='{"padding":"100rpx 24rpx","margin":"0 0 20rpx 0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='huanzhe'" class="userinfo">
					...
					<view :style='{"width":"240rpx","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#fff"}'>{{user.huanzhezhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					...
					<view :style='{"margin":"20rpx 0 0","flexDirection":"row","display":"flex","gap":"20rpx","width":"100%","flexFlow":"wrap","justifyContent":"center"}' class="info">
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","color":"#FFFFFF","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"36rpx","fontSize":"24rpx"}'>
							<span :style='{"color":"inherit"}'>患者电话：</span>
							<span :style='{"color":"inherit"}'>{{user.huanzhedianhua}}</span>
						</view>
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","color":"#FFFFFF","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"36rpx","fontSize":"24rpx"}'>
							<span :style='{"color":"inherit"}'>家属电话：</span>
							<span :style='{"color":"inherit"}'>{{user.jiashudianhua}}</span>
						</view>
					</view>
					<view :style='{"width":"100%","margin":"20rpx 0","display":"flex"}'>
					  <view :style='{"margin":"0","alignItems":"center","background":"#3d4e81","display":"flex","width":"50%","justifyContent":"center","height":"60rpx"}'>
					    <text class="icon iconfont icon-zan10" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"28rpx","color":"#fff"}'></text>
					    <text :style='{"color":"#fff","lineHeight":"1.5","fontSize":"28rpx"}'>点赞 {{user.thumbsnum}}</text>
					  </view>
					  <view :style='{"margin":"0","alignItems":"center","background":"#D1E0EE","display":"flex","width":"50%","justifyContent":"center","height":"60rpx"}'>
					    <text class="icon iconfont icon-shoucang10" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"28rpx","color":"#6683A2"}'></text>
	...
	export default {
		...
		methods: {
			...
			async getRecommendList(){
				...
				this.recommendTable = 'jiankangwenzhang'
				this.recommendTitle = 'biaoti'
				this.recommendPicture = 'fengmiantupian'
				this.$forceUpdate()
			},
			recommendDetail(id) {
				uni.navigateTo({
