		...
		<view class="container" :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#E9E9E9","height":"auto"}'>
			...
			<view :style='{"padding":"20rpx","margin":"-80rpx 0 0","background":"none","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#929292","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>发布时间：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.fabushijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#929292","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>健康分类：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.jiankangfenlei}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#929292","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>简介：</view>
	...
	export default {
		...
		async onShow(options) {
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('jiankangshipin', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','jiankangshipin');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('jiankangshipin',_this.detail)
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','jiankangshipin');
			...
			async init(type=1){
				...
				let res = await this.$api.info('jiankangshipin', this.id);
				let reg=new RegExp('http://localhost:8080/springbootf73c0283/upload','g')//g代表全部
				if(res.data.neirong){
				...
				if(type==2){
					...
					await this.$api.update('jiankangshipin',this.detail)
				}
			},
